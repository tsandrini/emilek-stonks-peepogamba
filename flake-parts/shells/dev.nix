...
let
  scripts = {
    rename-project = writeShellScriptBin "rename-project" ''
      find $1 \( -type d -name .git -prune \) -o -type f -print0 | xargs -0 sed -i "s/emilek-stonks-peepogamba/$2/g"
    '';
  };
...
mkShell {
  ...
  shellHook = ''
    ...
    # Welcome splash text
    echo ""; echo -e "\e[1;37;42mWelcome to the emilek-stonks-peepogamba devshell!\e[0m"; echo ""
  '';
}
